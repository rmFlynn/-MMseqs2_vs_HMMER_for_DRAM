...
from compare_mmseqs_hmmer_table import make_combo_df
...
mmseqs_df = read_mmseqs_results("/home/projects/DRAM/hmmer_mmseqs2_testing_take_3/results/vogdb_by_vogdb/mmseqs/vogdb_by_vogdb_mmseqs_t32_results_2021_06_17_18/sweep_output/evalue_1e-15_sens_7.500000")
...
"""
vogs = pd.DataFrame({'annotation': list_vogs(RA)})
